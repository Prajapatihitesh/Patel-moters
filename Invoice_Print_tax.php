  ...
  $x=$this->GetX();
    ...
    for ($i=0; $i < $rowcount1 ; $i++) {
      $rowcount++;
        ...
        $this->SetFont("Arial","",8);
        $this->cell(64.5,5,"PAN: AALFP95791",'LR',0);
        $this->cell(64.5,5,"BANK DETAIL:",'LR',0);
        $this->cell(0,5,"",'LR',1);

        $this->cell(64.5,5,"  Terms & Conditions",'LR',0);
        $this->cell(64.5,5,"A/C NAME: PATEL MOTORS",'LR',0);
        $this->cell(0,5,"",'LR',1);

        $this->cell(64.5,5,"1.Subject To Gandhidham Jurisdiction Only.",'LR',0);
        $this->cell(64.5,5,"A/C NO: 025905500923",'LR',0);
        $this->cell(0,5,"",'LR',1);

        $this->cell(64.5,5,"2.Goods Once Sold Will Not Be Returned Or ",'LR',0);
        $this->cell(64.5,5,"BANK NAME: ICICI BANK LTD",'LR',0);
        $this->cell(0,5,"",'LR',1);

        $this->cell(64.5,5,"Taken Back.",'LR',0);
        $this->cell(64.5,5,"BRANCH: GANIDHAM-KUTCH",'LR',0);
        $this->cell(0,5,"",'LR',1);

        $this->cell(64.5,5,"3.No claim will be accepted unless notified within",'LR',0);
        $this->cell(64.5,5,"IFSC CODE: ICIC0000259",'LR',0);
        $this->cell(0,5,"",'LR',1);

        $this->cell(64.5,5,"3 days.",'LRB',0);
        $this->cell(64.5,5,"",'LRB',0);

        $this->SetFont("Arial","B",12);
        $this->cell(0,5,"AUTHORISED SIGNATORY",'LRB',1);
      }
}
$pdf = new PDF();
$pdf ->AliasNbPages();
